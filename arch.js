...
const DEFAULT_CONFIG = {
  ...
  scenes: {
    ...
    healthcare: {
      startType: 'reception',
      types: ['reception', 'waiting', 'exam', 'consult', 'nurse', 'lab', 'imaging', 'restroom', 'corridor'],
      adj: {
    ...
    facade: {
      startType: 'entrance',
      types: ['entrance', 'window', 'shopfront', 'balcony', 'spandrel', 'cornice', 'pier'],
      adj: {
