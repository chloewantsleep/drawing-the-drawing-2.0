...
def main():
    ...
    out = os.path.join(os.path.dirname(__file__), '..', 'public', 'diffusion', 'samples.json')
    out = os.path.abspath(out)
    os.makedirs(os.path.dirname(out), exist_ok=True)
    payload = {'types': TYPES, 'layouts': samples,
               'note': 'generated by a tiny 8-D DDPM trained on rule-based synthetic apartments'}
